...
const Hsection1 = ({ infoCards = [] }) => {
    if (!infoCards || infoCards.length === 0) {
        return (
            <section id="about" className="herbs-section">
                <div className="herbs-container">
                    <h2 className="section-title">ما هي الأعشاب والزيوت؟</h2>
        ...
        <section id="about" className="herbs-section">
            <div className="herbs-container">
                <motion.h2 
                    ...
                    viewport={{ once: true }}
                >
                    ما هي الأعشاب والزيوت؟
                </motion.h2>
                <div className="cards-grid">
                    {infoCards.map((card, index) => (
                        <motion.div
                            key={card.id}
                            className="herbs-card"
