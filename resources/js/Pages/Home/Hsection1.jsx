...
const Hsection1 = () => {
    const stats = [
        ...
        { number: '5000+', label: 'عميل ' },
        { number: '7+', label: 'خدمه طبيه' },
        { number: '50+', label: 'مئهلات طبيه' }
    ];
...
نحن مركز متخصص في العلاج الطبيعي والحجامة، نسعى لتقديم رعاية صحية متكاملة تساعد مرضانا على استعادة عافيتهم وتحسين جودة حياتهم.
                    ...
                    <p>
                    يضم مركزنا نخبة من الأخصائيين ذوي الخبرة من الرجال و النساء، نستخدم أحدث الأساليب الطبية والطرق العلاجية الطبيعية، مع الحرص على متابعة كل حالة بعناية خاصة.
